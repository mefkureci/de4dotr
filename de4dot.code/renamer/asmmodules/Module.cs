...
public class Module : IResolver {
	readonly List<CustomAttributeRef> customAttributeFieldRefs = new();
	readonly List<CustomAttributeRef> customAttributePropertyRefs = new();
	readonly IList<RefToDef<MemberRef, FieldDef>> fieldRefsToRename = new List<RefToDef<MemberRef, FieldDef>>();
	readonly IList<RefToDef<MemberRef, MethodDef>> methodRefsToRename = new List<RefToDef<MemberRef, MethodDef>>();
	readonly IList<RefToDef<TypeRef, TypeDef>> typeRefsToRename = new List<RefToDef<TypeRef, TypeDef>>();
	List<MethodDef> allMethods;
	MemberRefFinder memberRefFinder;
	TypeDefDict types = new();
