...
public class DeobfuscatorInfo : DeobfuscatorInfoBase {
	...
	readonly BoolOption restoreResourceNames;
	...
	protected override IEnumerable<Option> GetOptionsInternal() =>
		new List<Option> { inlineMethods, removeInlinedMethods, removeNamespaces, restoreResourceNames };
}

class Deobfuscator : DeobfuscatorBase {
	readonly Options options;
	bool foundSpicesAttribute;
	...
	public override void DeobfuscateEnd() {
		...
		if (options.RestoreResourceNames) {
			...
			AddTypeToBeRemoved(resourceNamesRestorer.ComponentResourceManagerType,
				"Obfuscator ComponentResourceManager type");
		}
	...
	void RemoveInlinedMethods() {
		...
		var unusedMethods = new UnusedMethodsFinder(module, methodCallInliner.GetInlinedMethods(), GetRemovedMethods())
			.Find();
