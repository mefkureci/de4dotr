...
class ProxyCallFixer : ProxyCallFixer2 {
	readonly MethodDefAndDeclaringTypeDict<ProxyCreatorType> methodToType = new();
	...
	protected override object CheckCctor(TypeDef type, MethodDef cctor) {
		...
		for (int i = 0; i < instructions.Count; i++) {
			...
			var instrs = DotNetUtils.GetInstructions(instructions, i, OpCodes.Ldtoken, OpCodes.Ldc_I4, OpCodes.Ldc_I4,
				OpCodes.Ldtoken, OpCodes.Call);
			if (instrs != null) {
			...
			else if ((instrs = DotNetUtils.GetInstructions(instructions, i, OpCodes.Ldtoken, OpCodes.Ldc_I4,
				         OpCodes.Ldtoken, OpCodes.Call)) != null) {
				delegateType = instrs[0].Operand as ITypeDefOrRef;
				methodToken = instrs[1].GetLdcI4Value();
	...
	public void FindDelegateCreator() {
		string[] requiredTypes = new[] { "System.ModuleHandle" };
		foreach (var type in module.Types) {
			...
			foreach (var method in type.Methods) {
				...
				if (!DotNetUtils.IsMethod(method, "System.Void",
					    "(System.RuntimeTypeHandle,System.Int32,System.RuntimeFieldHandle)") &&
				    !DotNetUtils.IsMethod(method, "System.Void",
					    "(System.RuntimeTypeHandle,System.Int32,System.Int32,System.RuntimeFieldHandle)"))
					continue;
	...
	ProxyCreatorType GetProxyCreatorType(MethodDef methodToCheck) {
		foreach (var calledMethod in DotNetUtils.GetCalledMethods(module, methodToCheck)) {
			...
			if (DotNetUtils.IsMethod(calledMethod, "System.Void",
				    "(System.Reflection.FieldInfo,System.Type,System.Reflection.MethodInfo)"))
				return ProxyCreatorType.CallOrCallvirt;
			if (DotNetUtils.IsMethod(calledMethod, "System.Void",
				    "(System.Reflection.FieldInfo,System.Type,System.Reflection.ConstructorInfo)"))
	...
	class Context {
		...
		public Context(ITypeDefOrRef delegateType, int methodToken, int declaringTypeToken,
