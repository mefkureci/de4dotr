...
class MethodRefReader {
	readonly BabelMethodreference bmr;
	readonly ImageReader imageReader;
...
class MethodDefReader {
	readonly BabelMethodDef bmd;
	readonly MethodBodyReader methodBodyReader;
	readonly MethodRefReader methodRefReader;
