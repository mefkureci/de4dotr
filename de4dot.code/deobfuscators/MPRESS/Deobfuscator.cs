...
public class DeobfuscatorInfo : DeobfuscatorInfoBase {
	...
	public override IDeobfuscator CreateDeobfuscator() =>
		new Deobfuscator(new Deobfuscator.Options { ValidNameRegex = validNameRegex.Get() });

	protected override IEnumerable<Option> GetOptionsInternal() => new List<Option>();
}

class Deobfuscator : DeobfuscatorBase {
	static readonly string[] requiredFields = new[] { "System.Reflection.Assembly" };

	static readonly MethodInfo[] methods_v0x = new[] {
		...
		new MethodInfo("System.Int32",
			"(System.Byte[],System.Int32,System.Int32,System.Byte[],System.Int32,System.Int32)"),
		new MethodInfo("System.Int32", "(System.String[])")
	};

	static readonly MethodInfo[] methods_v1x = new[] {
		new MethodInfo("System.Void", "()", ".ctor"),
		new MethodInfo("System.Boolean", "(System.String,System.Byte[]&)"),
	...
	public override bool GetDecryptedModule(int count, ref byte[] newFileData, ref DumpedMethods dumpedMethods) {
		...
		using (var peImage = new MyPEImage(fileData)) {
			...
			uint offset = section.PointerToRawData;
			offset += 16;
	...
	void FixInvalidMvid() {
		if (module.Mvid == Guid.Empty) {
			byte[] hash = new SHA1Managed().ComputeHash(Encoding.UTF8.GetBytes(module.ToString()));
