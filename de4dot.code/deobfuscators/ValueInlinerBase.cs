...
public abstract class ValueInlinerBase<TValue> : MethodReturnValueInliner {
	readonly MethodDefAndDeclaringTypeDict<Func<MethodDef, MethodSpec, object[], object>> decrypterMethods = new();

	public bool RemoveUnbox { get; set; }
	...
	class MyCallResult : CallResult {
		...
		public readonly IMethod methodRef;
