...
class MethodBodyReader : MethodBodyReaderBase {
	...
	protected override IField ReadInlineField(Instruction instr) =>
		module.ResolveToken(reader.ReadUInt32(), gpContext) as IField;

	protected override IMethod ReadInlineMethod(Instruction instr) =>
		module.ResolveToken(reader.ReadUInt32(), gpContext) as IMethod;
	...
	protected override ITokenOperand ReadInlineTok(Instruction instr) =>
		module.ResolveToken(reader.ReadUInt32(), gpContext) as ITokenOperand;

	protected override ITypeDefOrRef ReadInlineType(Instruction instr) =>
		module.ResolveToken(reader.ReadUInt32(), gpContext) as ITypeDefOrRef;
