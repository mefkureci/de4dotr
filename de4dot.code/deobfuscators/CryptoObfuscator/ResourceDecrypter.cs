...
class ResourceDecrypter {
	...
	static readonly string[] requiredTypes = new[] { "System.IO.MemoryStream", "System.Object", "System.Int32" };

	static readonly string[] requiredLocals_v1 = new[] {
		"System.Boolean", "System.Byte", "System.Byte[]", "System.Int32",
		"System.Security.Cryptography.DESCryptoServiceProvider"
	};

	static readonly string[] requiredLocals_sl = new[] { "System.Byte", "System.Byte[]", "System.Int32" };

	readonly byte[] buffer1 = new byte[BUFLEN];
	readonly byte[] buffer2 = new byte[BUFLEN];
		...
		foreach (var type in module.Types) {
			...
			foreach (var method in GetDecrypterMethods(type)) {
				...
				if (!DotNetUtils.CallsMethod(method, "System.Int32", "(System.Byte[],System.Int32,System.Int32)"))
					continue;
				if (!DotNetUtils.CallsMethod(method, "System.Void",
		...
		if ((flags & desEncryptedFlag) != 0) {
			...
			using (var provider = new DESCryptoServiceProvider()) {
				...
				using (var transform = provider.CreateDecryptor()) {
					...
					byte[] finalData = transform.TransformFinalBlock(buffer1, 0, 0);
