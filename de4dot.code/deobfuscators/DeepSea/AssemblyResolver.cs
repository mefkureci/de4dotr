...
class AssemblyResolver : ResolverBase {
	static readonly string[] requiredLocals_sl = new[] {
		"System.Byte[]", "System.IO.Stream", "System.Reflection.Assembly", "System.Security.Cryptography.SHA1Managed",
		"System.Windows.AssemblyPart"
	};

	static readonly string[] handlerLocalTypes_NET = new[] {
		"System.Byte[]", "System.IO.Compression.DeflateStream", "System.IO.MemoryStream", "System.IO.Stream",
		"System.Reflection.Assembly", "System.Security.Cryptography.SHA1CryptoServiceProvider", "System.String"
	};

	static readonly string[] handlerLocalTypes_SL = new[] {
		"System.Byte[]", "System.IO.Stream", "System.Reflection.Assembly", "System.Security.Cryptography.SHA1Managed",
		"System.String", "System.Windows.AssemblyPart"
	};
	...
	public MethodDef DecryptMethod { get; private set; }
	...
	protected override bool CheckResolverInitMethodInternal(MethodDef resolverInitMethod) =>
		DotNetUtils.CallsMethod(resolverInitMethod,
	...
	bool CheckHandlerV4(MethodDef handler, out List<FieldInfo> fieldInfos, out MethodDef decryptMethod) {
		...
		for (int i = 0; i < instrs.Count - 3; i++) {
			...
			if (!DotNetUtils.IsMethod(decryptMethodTmp, "System.Reflection.Assembly",
				    "(System.RuntimeFieldHandle,System.Int32,System.Int32)"))
				return false;
	...
	AssemblyInfo GetAssemblyInfo(EmbeddedResource resource, Func<EmbeddedResource, byte[]> decrypter) {
		try {
			byte[] decrypted = decrypter(resource);
	...
	AssemblyInfo GetAssemblyInfo(byte[] decryptedData, EmbeddedResource resource) {
		...
		string simpleName = asm.Name.String;
		string extension = DeobUtils.GetExtension(asm.Modules[0].Kind);
	...
	IEnumerable<AssemblyInfo> GetAssemblyInfos(Func<byte[], int, byte[]> decrypter) {
		...
		foreach (var fieldInfo in fieldInfos) {
			byte[] decrypted = decrypter(fieldInfo.field.InitialValue, fieldInfo.magic);
	...
	IEnumerable<AssemblyInfo> GetAssemblyInfosV41() =>
		GetAssemblyInfos((data, magic) => InflateIfNeeded(Decrypt41Trial(data, magic)));
	...
	public class AssemblyInfo {
		...
		public AssemblyInfo(byte[] data, string fullName, string simpleName, string extension,
