...
class ResourceResolver : ResolverBase {
	static readonly string[] handlerLocalTypes_V3 = new[] {
		"System.AppDomain", "System.Byte[]", "System.Collections.Generic.Dictionary`2<System.String,System.String>",
		"System.IO.Compression.DeflateStream", "System.IO.MemoryStream", "System.IO.Stream",
		"System.Reflection.Assembly", "System.String", "System.String[]"
	};
	...
	bool CheckHandlerV41(HandlerInfo info, out Data41 data41) {
		...
		if (magicArgIndex < 0 || magicArgIndex >= info.args.Count)
			return false;
		object val = info.args[magicArgIndex];
		if (!(val is int))
			return false;
		if (data41.isTrial)
	...
	static Data40 CheckHandlerV40(MethodDef handler) {
		...
		for (int i = 0; i < instrs.Count; i++) {
			...
			string methodSig =
				"(System.ResolveEventArgs,System.RuntimeFieldHandle,System.Int32,System.String,System.Int32)";
			...
			if (method != null) {
				...
				methodSig =
					"(System.ResolveEventArgs,System.RuntimeMethodHandle,System.Int32,System.String,System.Int32)";
			}
	...
	public bool MergeResources(out EmbeddedResource rsrc) {
		...
		case ResourceVersion.V3:
			...
			DeobUtils.DecryptAndAddResources(module, data30.resource.Name.String,
				() => DecryptResourceV3(data30.resource));
	...
	class HandlerInfo {
		...
		public readonly MethodDef handler;
