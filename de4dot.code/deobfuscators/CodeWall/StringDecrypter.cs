...
class StringDecrypter {
	...
	static readonly string[] requiredTypes_v30 = new[] {
		"System.Collections.Generic.Dictionary`2<System.Int32,System.String>"
	};

	static readonly string[] requiredLocals_v30 = new[] {
		"System.Int32", "System.Byte[]", "System.Reflection.Assembly", "System.IO.Stream", "System.Random",
		"System.String"
	};

	static readonly string[] requiredTypes_v36 = new[] {
		"System.Object", "System.Collections.Generic.Dictionary`2<System.Int32,System.String>"
	};

	static readonly string[] requiredLocals_v36 = new[] {
		"System.Int32", "System.Byte[]", "System.Reflection.Assembly", "System.IO.Stream", "System.Random",
		"System.String", "System.Object"
	};

	readonly ModuleDefMD module;
	readonly MethodDefAndDeclaringTypeDict<StringEncrypterInfo> stringEncrypterInfos = new();

	public StringDecrypter(ModuleDefMD module) => this.module = module;

	public bool Detected => stringEncrypterInfos.Count != 0;
	public Version TheVersion { get; private set; }
	...
	public class StringEncrypterInfo {
		...
		public string Decrypt(int magic1, int magic2, int magic3) {
			...
			byte[] key = GetKey(magic1 ^ Magic1, dataLen);
		...
		public override string ToString() =>
			$"{Method.MDToken.ToInt32():X8} M1:{Magic1:X8} M2:{Magic2:X8} M3:{Magic3:X8}";
	}
}
