...
static class ConfuserUtils {
	...
	static readonly string[] outWindowFields = new[] { "System.Byte[]", "System.UInt32", "System.IO.Stream" };
	...
	public static bool RemoveResourceHookCode(Blocks blocks, MethodDef handler) =>
		RemoveResolveHandlerCode(blocks, handler,
		...
		foreach (var block in blocks.MethodBlocks.GetAllBlocks()) {
			...
			for (int i = 0; i < instrs.Count - 4; i++) {
				...
				if (calledMethod == null ||
				    calledMethod.FullName != "System.AppDomain System.AppDomain::get_CurrentDomain()")
					continue;
	...
	public static byte[] DecryptCompressedInt32Data(Arg64ConstantsReader constReader, int exprStart, int exprEnd,
		ref DataReader reader, byte[] decrypted) {
