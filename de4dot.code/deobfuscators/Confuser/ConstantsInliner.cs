...
class ConstantsInliner : IBlocksDeobfuscator {
	readonly DoubleValueInliner doubleValueInliner;
	readonly Int32ValueInliner int32ValueInliner;
	readonly Int64ValueInliner int64ValueInliner;
	readonly SingleValueInliner singleValueInliner;
	Blocks blocks;

	public ConstantsInliner(Int32ValueInliner int32ValueInliner, Int64ValueInliner int64ValueInliner,
