...
class ConstantsDecrypterV17 : ConstantsDecrypterBase {
	static readonly string[] requiredLocalsCctor = new[] {
		"System.Reflection.Assembly", "System.IO.Compression.DeflateStream", "System.Byte[]", "System.Int32"
	};
	...
	public void Find() {
		...
		if (resourceName != null) {
			...
			if (keyArraySize == 8)
				InitVersion(method, ConfuserVersion.v17_r75056_normal, ConfuserVersion.v17_r75056_dynamic,
					ConfuserVersion.v17_r75056_native);
			else if (keyArraySize == 16)
				InitVersion(method, ConfuserVersion.v18_r75257_normal, ConfuserVersion.v18_r75257_dynamic,
					ConfuserVersion.v18_r75257_native);
			else
				return;
		}
		else if (DotNetUtils.CallsMethod(method, "System.String System.Reflection.Module::get_ScopeName()"))
			InitVersion(method, ConfuserVersion.v17_r74816_normal, ConfuserVersion.v17_r74816_dynamic,
				ConfuserVersion.v17_r74816_native);
		else if (DotNetUtils.CallsMethod(method,
			         "System.Reflection.Module System.Reflection.Assembly::GetModule(System.String)"))
			InitVersion(method, ConfuserVersion.v17_r74788_normal, ConfuserVersion.v17_r74788_dynamic,
				ConfuserVersion.v17_r74788_native);
		else
			InitVersion(method, ConfuserVersion.v17_r74708_normal, ConfuserVersion.v17_r74708_dynamic,
				ConfuserVersion.v17_r74708_native);
	...
	protected override byte[] DecryptData(DecrypterInfo info2, MethodDef caller, object[] args, out byte typeCode) {
		...
		uint offs = info.CalcHash(info2.decryptMethod.MDToken.ToUInt32() ^
		                          (info2.decryptMethod.DeclaringType.MDToken.ToUInt32() * (uint)args[0])) ^
		            (uint)args[1];
		...
		byte[] encrypted = reader.ReadBytes(reader.ReadInt32());
	...
	byte[] DecryptConstant(DecrypterInfoV17 info, byte[] encrypted, uint offs, byte typeCode) {
		...
		case ConfuserVersion.v17_r74708_normal:
			return DecryptConstant_v17_r74708_normal(info, encrypted, offs, typeCode);
		case ConfuserVersion.v17_r74708_dynamic:
			return DecryptConstant_v17_r74708_dynamic(info, encrypted, offs, typeCode);
		case ConfuserVersion.v17_r74708_native:
			return DecryptConstant_v17_r74708_native(info, encrypted, offs, typeCode);
		case ConfuserVersion.v17_r74788_normal:
			return DecryptConstant_v17_r74788_normal(info, encrypted, offs, typeCode);
		case ConfuserVersion.v17_r74788_dynamic:
			return DecryptConstant_v17_r74788_dynamic(info, encrypted, offs, typeCode);
		case ConfuserVersion.v17_r74788_native:
			return DecryptConstant_v17_r74788_native(info, encrypted, offs, typeCode);
	...
	byte[] GetKey_v17_r74788(DecrypterInfoV17 info) {
		byte[] key = module.ReadBlob(info.decryptMethod.MDToken.ToUInt32() ^ info.key5);
	...
	static bool CheckMethods(IEnumerable<MethodDef> methods) {
		...
		foreach (var method in methods) {
			if (method.Name == ".ctor" || method.Name == ".cctor")
				return false;
			if (method.Attributes != (MethodAttributes.Static | MethodAttributes.HideBySig |
	...
	static string GetResourceName(MethodDef method) {
		...
		for (int i = 0; i < instrs.Count; i++) {
			i = ConfuserUtils.FindCallMethod(instrs, i, Code.Call,
