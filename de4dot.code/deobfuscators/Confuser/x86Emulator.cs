...
class X86Emulator : IDisposable {
	...
	static readonly byte[] prolog1 = new byte[] { 0x8B, 0x44, 0x24, 0x04, 0x53, 0x50 };

	static readonly byte[] epilog1 = new byte[] { 0x5B, 0xC3 };

	// Confuser 1.7 r74021+
	static readonly byte[] prolog2 = new byte[] {
		0x89, 0xE0, 0x53, 0x57, 0x56, 0x29, 0xE0, 0x83, 0xF8, 0x18, 0x74, 0x07, 0x8B, 0x44, 0x24, 0x10, 0x50, 0xEB,
		0x01, 0x51
	};

	static readonly byte[] epilog2 = new byte[] { 0x5E, 0x5F, 0x5B, 0xC3 };

	readonly uint[] regs = new uint[8];
	uint[] args;
	...
	public uint Emulate(uint rva, uint arg) => Emulate(rva, new[] { arg });
	...
	class Instruction {
		public readonly IOperand op1;
		public readonly IOperand op2;
