...
class ConstantsDecrypterV15 : ConstantsDecrypterBase {
	static readonly string[] requiredLocals1 = new[] {
		"System.Byte[]", "System.Collections.Generic.Dictionary`2<System.UInt32,System.Object>",
		"System.IO.BinaryReader", "System.IO.Compression.DeflateStream", "System.IO.MemoryStream",
		"System.Reflection.Assembly"
	};

	static readonly string[] requiredLocals2 = new[] {
		"System.Byte[]", "System.IO.BinaryReader", "System.IO.Compression.DeflateStream", "System.Reflection.Assembly"
	};
	...
	bool InitializeFields(DecrypterInfo info) {
		...
		case ConfuserVersion.v17_r74021_native:
			if (!Add(ConstantsDecrypterUtils.FindDictField(info.decryptMethod, info.decryptMethod.DeclaringType)))
				return false;
			if (!Add(
				    ConstantsDecrypterUtils.FindMemoryStreamField(info.decryptMethod,
					    info.decryptMethod.DeclaringType)))
				return false;
			break;
		}
	...
	byte[] DecryptConstant_v15_r60785_dynamic(DecrypterInfo info, byte[] encrypted, uint offs) {
		...
		byte[] decrypted = new byte[dataReader.ReadInt32()];
