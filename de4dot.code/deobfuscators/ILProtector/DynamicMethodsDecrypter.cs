...
sealed class DynamicMethodsDecrypter : IDisposable {
	...
	readonly Module reflectionModule;
	...
	public bool MethodReaderHasDelegateTypeFlag { get; private set; }
	...
	public DecryptedMethodInfo Decrypt(int methodId, uint rid) {
		...
		if (methodData == null)
			throw new ApplicationException(
				$"Probably a new version. Could not decrypt method. ID:{methodId}, RID:{rid:X4}");
	...
	static FieldDef FindDelegateFieldV1_0_7_0(TypeDef mainType) =>
		FindDelegateField(mainType, "System.Boolean",
			"(System.Int32,System.Int32,System.Int32,System.Byte*&,System.Int32&)");

	static FieldDef FindDelegateFieldV2_0_0_0(TypeDef mainType) =>
		FindDelegateField(mainType, "System.Boolean",
			"(System.Int32,System.Int32,System.Int32,System.Int32,System.Byte*&,System.Int32&)");
	...
	static FieldDef FindDelegateFieldV2_0_8_0(TypeDef mainType, FieldDef decryptCallbackField) {
		...
		if (type == null)
			return null;
		return FindDelegateField(mainType, "System.Boolean",
			$"(System.Int32,System.Int32,System.Int32,System.Int32,{type.FullName},System.Delegate&)");
	}
	...
	static FieldDef FindDelegateFieldV2_0_8_5(TypeDef mainType, FieldDef decryptCallbackField) {
		...
		if (type == null)
			return null;
		return FindDelegateField(mainType, "System.Boolean",
			$"(System.Int32,System.Int32,System.Int32,System.Int32,System.Diagnostics.StackTrace,{type.FullName},System.Delegate&)");
	}
	...
	static FieldDef FindDelegateFieldV2_0_9_0(TypeDef mainType, FieldDef decryptCallbackField) {
		...
		if (type == null)
			return null;
		return FindDelegateField(mainType, "System.Boolean",
			$"(System.Int32,System.Int32,System.Int32,System.Int32,System.Diagnostics.StackTrace,{type.FullName})");
	}
	...
	abstract class DecrypterBase : IDecrypter {
		...
		static readonly Dictionary<Version, PatchInfo> patchInfos32 = new() {
		...
		static readonly Dictionary<Version, PatchInfo> patchInfos64 = new() {
		...
		static IntPtr GetNativeAddressOfDelegate(Delegate del) {
			var field = typeof(Delegate).GetField("_methodPtrAux",
		...
		class PatchInfo {
			...
			public int RvaDecryptMethod { get; }
			public List<PatchData> PatchData { get; }
		}
	}

	// 1.0.7.0 - 1.0.8.0
	class DecrypterV1_0_7_0 : DecrypterBase {
		readonly DecryptMethod decryptMethod;
		...
		public override unsafe byte[] Decrypt(int methodId, uint rid) {
			if (!decryptMethod(appDomainId, asmHashCode, methodId, out byte* pMethodCode, out int methodSize))
				return null;
		...
		unsafe delegate bool DecryptMethod(int appDomainId, int asmHashCode, int methodId, out byte* pMethodCode,
			out int methodSize);
	}
	...
	class DecrypterV2_0_0_0 : DecrypterBase {
		...
		public override unsafe byte[] Decrypt(int methodId, uint rid) {
			if (!decryptMethod(Environment.Version.Major, appDomainId, asmHashCode, methodId, out byte* pMethodCode,
				    out int methodSize))
				return null;
			byte[] methodData = new byte[methodSize];
			Marshal.Copy(new IntPtr(pMethodCode), methodData, 0, methodData.Length);
		...
		unsafe delegate bool DecryptMethod(int clrMajorVersion, int appDomainId, int asmHashCode, int methodId,
			out byte* pMethodCode, out int methodSize);
	}
	...
	class DecrypterV2_0_8_0 : DecrypterBase {
		...
		public override unsafe byte[] Decrypt(int methodId, uint rid) {
			if (!decryptMethod(Environment.Version.Major, appDomainId, asmHashCode, methodId, MyDecryptCallback,
		...
		delegate bool DecryptMethod(int clrMajorVersion, int appDomainId, int asmHashCode, int methodId,
			[MarshalAs(UnmanagedType.FunctionPtr)] DecryptCallback decryptCallback,
			[MarshalAs(UnmanagedType.Interface)] out Delegate createdDelegate);

		unsafe delegate bool DecryptCallback(byte* pMethodCode, int methodSize,
			[MarshalAs(UnmanagedType.Interface)] ref Delegate createdDelegate);
	}
	...
	class DecrypterV2_0_8_5 : DecrypterBase {
		...
		public override unsafe byte[] Decrypt(int methodId, uint rid) {
			...
			if (!decryptMethod(Environment.Version.Major, appDomainId, asmHashCode, methodId, new StackTrace(),
				    MyDecryptCallback, out var createdDelegate) &&
			    !decryptReturnValue)
				return null;
			return decryptedData;
		}
		...
		delegate bool DecryptMethod(int clrMajorVersion, int appDomainId, int asmHashCode, int methodId,
			[MarshalAs(UnmanagedType.Interface)] StackTrace stackTrace,
			[MarshalAs(UnmanagedType.FunctionPtr)] DecryptCallback decryptCallback,
			[MarshalAs(UnmanagedType.Interface)] out Delegate createdDelegate);
	...
	class DecrypterV2_0_9_0 : DecrypterBase {
		...
		public override unsafe byte[] Decrypt(int methodId, uint rid) {
			...
			if (!decryptMethod(Environment.Version.Major, appDomainId, asmHashCode, methodId, stackTrace,
				    MyDecryptCallback))
				return null;
			return decryptedData;
		}
	...
	abstract class DecrypterBaseV2_0_12_x : IDecrypter {
		...
		public byte[] Decrypt(int methodId, uint rid) {
			decryptedData = null;
			currentILBytes = dmd.reflectionModule.ResolveMethod(0x06000000 + (int)rid).GetMethodBody()
				.GetILAsByteArray();
			invoker.DynamicInvoke(methodId);
			return decryptedData;
		}
...
#pragma warning restore CS0618 // Type or member is obsolete
	...
	abstract class DecrypterV2_0_13_0_Base : IDecrypter {
		readonly byte[] aryDummy = new byte[7];
		readonly DecryptCallbackDelegate decryptCallbackDelegate;
		protected readonly DynamicMethodsDecrypter dmd;
		...
		public unsafe DecrypterV2_0_13_0_Base(DynamicMethodsDecrypter dmd) {
			...
			*(IntPtr*)(p + 0x29 * IntPtr.Size) =
				Marshal.GetFunctionPointerForDelegate(getCallerMethodAsILByteArrayDelegate);
...
#pragma warning restore CS0618 // Type or member is obsolete
	...
	class DecrypterV2_0_13_0 : DecrypterV2_0_13_0_Base {
		static readonly byte[] initCode_x86 = new byte[] {
			0x8B, 0xCC, 0x8B, 0x41, 0x04, 0xFF, 0x71, 0x10, 0xFF, 0x71, 0x0C, 0xFF, 0x71, 0x08, 0xFF, 0x51, 0x14, 0xC2,
			0x14, 0x00
		};

		public DecrypterV2_0_13_0(DynamicMethodsDecrypter dmd)
			: base(dmd) {
		}
		...
		protected override unsafe void InitCode(byte* ba, byte* pam, byte* pd, byte* pm) {
			...
			if (IntPtr.Size == 4) {
				var del = (InitCode32Delegate)Marshal.GetDelegateForFunctionPointer(
					CodeAllocator.Allocate(initCode_x86), typeof(InitCode32Delegate));
				del(pppam, pm, new IntPtr(IntPtr.Size * 4), pd, ba + 0x00012500);
			}
			else {
				var del = (InitCode64Delegate)Marshal.GetDelegateForFunctionPointer(new IntPtr(ba + 0x00014CF0),
					typeof(InitCode64Delegate));
	...
	class DecrypterV2_0_13_1 : DecrypterV2_0_13_0_Base {
		public DecrypterV2_0_13_1(DynamicMethodsDecrypter dmd)
			: base(dmd) {
		}

		protected override unsafe void InitCode(byte* ba, byte* pam, byte* pd, byte* pm) {
			int rva = IntPtr.Size == 4 ? 0x00013650 : 0x00016B50;
			var del = (InitCodeDelegate)Marshal.GetDelegateForFunctionPointer(new IntPtr(ba + rva),
				typeof(InitCodeDelegate));
			byte* ppam = (byte*)&pam;
			byte* pppam = (byte*)&ppam;
			del(pppam, pm, new IntPtr(IntPtr.Size * 4), pd);
		}
