...
class CompositeHandlerDetector {
	...
	readonly Stack<MatchState> stack = new();
	...
	struct HandlerState {
		...
		public HandlerState Clone() => new(BlockSigInfos, BlockIndex, HashIndex);
	}
	...
	struct FindHandlerState {
		...
		public FindHandlerState Clone() => new(CompositeState.Clone(), VisitedCompositeBlocks, Done);
	}
}
