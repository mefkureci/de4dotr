...
class CsvmInfo {
	...
	MethodDef FindLogicalOpMethodShrUn(TypeDef type) =>
		FindLogicalOpMethod(type, ElementType.U4, ElementType.I4, ElementType.U4, Code.Shr_Un);

	MethodDef FindLogicalOpMethodShl(TypeDef type) =>
		FindLogicalOpMethod(type, ElementType.I4, ElementType.I4, ElementType.I4, Code.Shl);

	MethodDef FindLogicalOpMethodShr(TypeDef type) =>
		FindLogicalOpMethod(type, ElementType.I4, ElementType.I4, ElementType.I4, Code.Shr);
