...
class ResourceDecrypter {
	static readonly string[] encryptedResourceReaderType_fields = new[] {
		"System.Boolean", "System.Int32", "System.Int64", "System.IO.BinaryReader",
		"System.Runtime.Serialization.Formatters.Binary.BinaryFormatter"
	};

	static readonly string[] encryptedResourceStreamType_fields = new[] {
		"System.Byte", "System.Byte[]", "System.Boolean", "System.Int32", "System.Int64", "System.IO.MemoryStream",
		"System.IO.Stream", "System.UInt32[]"
	};
	...
	public TypeDef EncryptedResourceStreamType { get; private set; }

	public TypeDef EncryptedResourceSetType { get; private set; }

	public TypeDef EncryptedResourceReaderType { get; private set; }

	public TypeDef ResType { get; private set; }

	public TypeDef ResourceFlagsType { get; private set; }

	public TypeDef ResourceEnumeratorType { get; private set; }
	...
	void FindResourceEnumerator() {
		...
		string[] resourceEnumeratorType_fields = new[] {
			"System.Collections.DictionaryEntry", "System.Collections.IDictionaryEnumerator", "System.Boolean",
	...
	void FindEncryptedResourceStreamType() {
		foreach (var type in module.Types) {
			...
			if (!FindManifestResourceStreamMethods(type, out var getManifestResourceStreamMethodTmp1,
				    out var getManifestResourceStreamMethodTmp2))
				continue;
			...
			if (DotNetUtils.IsMethod(method, "System.Void", "(System.UInt32[],System.UInt32[])")) {
				if (!DeobUtils.HasInteger(method, 0x9E3779B9))
					continue;
				         ...
				         "(System.UInt32[],System.UInt32[],System.UInt32,System.UInt32,System.UInt32,System.UInt32,System.UInt32,System.UInt32,System.UInt32,System.UInt32,System.UInt32)")) {
	...
	static bool FindManifestResourceStreamMethods(TypeDef type, out MethodDef getManifestResourceStreamMethodTmp1,
		out MethodDef getManifestResourceStreamMethodTmp2) {
		...
		foreach (var method in type.Methods) {
			...
			else if (DotNetUtils.IsMethod(method, "System.IO.Stream",
				         "(System.Reflection.Assembly,System.Type,System.String)"))
	...
	public void Decrypt() {
		for (int i = 0; i < module.Resources.Count; i++) {
			...
			byte[] decrypted = Decrypt(ref rsrcReader);
			if (decrypted == null)
				continue;
