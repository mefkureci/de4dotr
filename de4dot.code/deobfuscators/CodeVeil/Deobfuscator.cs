...
class Deobfuscator : DeobfuscatorBase {
	...
	public override void DeobfuscateBegin() {
		...
		if (Operations.DecryptStrings != OpDecryptString.None) {
			...
			AddCallToBeRemoved(mainType.GetInitStringDecrypterMethod(stringDecrypter.InitMethod),
				stringDecrypter.InitMethod);
		}
		...
		if (resourceDecrypter.CanRemoveTypes) {
			...
			AddTypeToBeRemoved(resourceDecrypter.EncryptedResourceReaderType,
				"Obfuscator EncryptedResourceReader type");
			AddTypeToBeRemoved(resourceDecrypter.EncryptedResourceSetType, "Obfuscator EncryptedResourceSet type");
			AddTypeToBeRemoved(resourceDecrypter.EncryptedResourceStreamType,
				"Obfuscator EncryptedResourceStream type");
		}
	}
