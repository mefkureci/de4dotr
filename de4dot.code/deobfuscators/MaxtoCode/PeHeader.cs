...
class PeHeader {
	...
	public PeHeader(MainType mainType, MyPEImage peImage) {
		EncryptionVersion = GetHeaderOffsetAndVersion(peImage, out uint headerOffset);
	...
	public EncryptionVersion EncryptionVersion { get; }
	...
	static EncryptionVersion GetHeaderOffsetAndVersion(ImageSectionHeader section, MyPEImage peImage,
		out uint headerOffset) {
