...
public class MemberRefBuilder {
	readonly Dictionary<TypeSig, TypeSig> createdTypes = new(TypeEqualityComparer.Instance);
	...
	public MemberRef InstanceMethod(string name, IMemberRefParent declaringType, TypeSig returnType,
		params TypeSig[] args) =>
		Method(true, name, declaringType, returnType, args);

	public MemberRef StaticMethod(string name, IMemberRefParent declaringType, TypeSig returnType,
		params TypeSig[] args) =>
		Method(false, name, declaringType, returnType, args);

	public MemberRef Method(bool isInstance, string name, IMemberRefParent declaringType, TypeSig returnType,
		params TypeSig[] args) {
		MethodSig sig;
		if (isInstance)
