...
public abstract class ProxyCallFixerBase {
	protected List<MethodDef> delegateCreatorMethods = new();
	protected Dictionary<TypeDef, bool> delegateTypesDict = new();
	...
	protected static void Add(Dictionary<Block, List<RemoveInfo>> removeInfos, Block block, int index,
		DelegateInfo di) {
...
public abstract class ProxyCallFixer1 : ProxyCallFixerBase {
	readonly FieldDefAndDeclaringTypeDict<DelegateInfo> fieldToDelegateInfo = new();
	...
	protected abstract void GetCallInfo(object context, FieldDef field, out IMethod calledMethod,
...
public abstract class ProxyCallFixer2 : ProxyCallFixerBase {
	readonly MethodDefAndDeclaringTypeDict<DelegateInfo> proxyMethodToDelegateInfo = new();
