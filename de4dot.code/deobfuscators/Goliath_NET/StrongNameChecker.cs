...
class StrongNameChecker {
	...
	public MethodDef CheckerMethod { get; private set; }
	...
	public void Find() {
		foreach (var type in module.Types) {
			...
			if (DotNetUtils.GetMethod(type, "System.Byte[]", "(System.Reflection.Assembly)") == null)
				continue;
			if (DotNetUtils.GetMethod(type, "System.String", "(System.Collections.Generic.Stack`1<System.Int32>)") ==
			    null)
				continue;
			...
			Type = type;
			CheckerMethod = checkMethod;
			return;
		}
	}

	MethodDef GetAntiTamperingDetectionMethod(TypeDef type) {
		string[] requiredLocals = new[] {
			"System.Reflection.Assembly", "System.Collections.Generic.Stack`1<System.Int32>"
		};
		...
		foreach (var block in blocks.MethodBlocks.GetAllBlocks()) {
			...
			for (int i = 0; i < instrs.Count - 2; i++) {
				...
				if (call2.OpCode.Code != Code.Call && call2.OpCode.Code != Code.Callvirt)
					continue;
				if (!MethodEqualityComparer.CompareDeclaringTypes.Equals(call2.Operand as IMethod, CheckerMethod))
					continue;
