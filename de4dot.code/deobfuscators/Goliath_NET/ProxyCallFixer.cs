...
class ProxyCallFixer : ProxyCallFixer2 {
	...
	protected override object CheckCctor(TypeDef type, MethodDef cctor) => throw new NotImplementedException();

	protected override void
		GetCallInfo(object context, FieldDef field, out IMethod calledMethod, out OpCode callOpcode) =>
		throw new NotImplementedException();

	class MyInfo {
		public readonly DelegateInfo delegateInfo;
