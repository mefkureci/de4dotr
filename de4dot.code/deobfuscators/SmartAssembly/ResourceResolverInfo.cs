...
class ResourceResolverInfo : ResolverInfoBase {
	readonly AssemblyResolverInfo assemblyResolverInfo;

	public ResourceResolverInfo(ModuleDefMD module, ISimpleDeobfuscator simpleDeobfuscator, IDeobfuscator deob,
	...
	public EmbeddedAssemblyInfo ResourceInfo { get; private set; }
	...
	protected override bool CheckHandlerMethod(MethodDef method) {
		...
		for (int i = 0; i < instructions.Count; i++) {
			...
			string s = instrs[0].Operand as string;
