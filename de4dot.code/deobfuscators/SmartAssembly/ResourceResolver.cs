...
class ResourceResolver {
	...
	readonly ResourceResolverInfo resourceResolverInfo;
	bool mergedIt;
	...
	public EmbeddedAssemblyInfo MergeResources() {
		...
		DeobUtils.DecryptAndAddResources(module, info.resourceName,
			() => assemblyResolver.RemoveDecryptedResource(info));
		mergedIt = true;
		return info;
	}
}
