...
class StringEncoderClassFinder {
	static readonly string[] fields1x = new[] { "System.IO.Stream" };
	...
	public IList<StringsEncoderInfo> StringsEncoderInfos { get; } = new List<StringsEncoderInfo>();
	...
	void FindHouseOfCardsStrings_v2() {
		foreach (var type in module.Types) {
			if (type.Methods.Count != 1)
				continue;
			foreach (var method in DotNetUtils.FindMethods(type.Methods, "System.Void", new[] { "System.Type" })) {
