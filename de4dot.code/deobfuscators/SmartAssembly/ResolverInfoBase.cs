...
abstract class ResolverInfoBase {
	...
	public MethodDef CallResolverMethod { get; private set; }
	...
	IEnumerable<MethodDef> GetResolverHandlers(MethodDef method) {
		...
		for (int i = 0; i < instructions.Count; i++) {
			var instrs = DotNetUtils.GetInstructions(instructions, i, OpCodes.Call, OpCodes.Ldnull, OpCodes.Ldftn,
