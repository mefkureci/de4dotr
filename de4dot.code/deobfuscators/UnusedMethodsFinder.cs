...
public class UnusedMethodsFinder {
	...
	readonly Stack<MethodDef> notUnusedStack = new();
	readonly Dictionary<MethodDef, bool> possiblyUnusedMethods = new();
	readonly MethodCollection removedMethods;

	public UnusedMethodsFinder(ModuleDef module, IEnumerable<MethodDef> possiblyUnusedMethods,
