...
class ProxyCallFixer : ProxyCallFixer3 {
	readonly MethodDefAndDeclaringTypeDict<bool> proxyTargetMethods = new();
	public ProxyCallFixer(ModuleDefMD module) : base(module) { }

	public TypeDef ProxyMethodsType { get; private set; }
	...
	static MethodDef CheckMethods(TypeDef type) {
		...
		foreach (var method in type.Methods) {
			...
			if (DotNetUtils.IsMethod(method, "System.MulticastDelegate",
				    "(System.Type,System.Reflection.MethodInfo,System.Int32)"))
				continue;
	...
	protected override void GetCallInfo(object context, FieldDef field, out IMethod calledMethod,
		...
		uint rid = 0;
		foreach (char c in field.Name.String)
