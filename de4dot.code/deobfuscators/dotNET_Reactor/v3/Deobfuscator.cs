...
class Deobfuscator : DeobfuscatorBase {
	...
	static readonly Regex isRandomNameMembers = new(@"^[a-zA-Z0-9]{9,11}$"); // methods, fields, props, events
	static readonly Regex isRandomNameTypes = new(@"^[a-zA-Z0-9]{18,19}(?:`\d+)?$"); // types, namespaces
	readonly Options options;
	readonly List<UnpackedFile> unpackedFiles = new();
