...
class AssemblyResolver {
	...
	public AssemblyResolver(ModuleDefMD module, AssemblyResolver oldOne) {
		this.module = module;
		Type = Lookup(oldOne.Type, "Could not find assembly resolver type");
		assemblyResolverMethod = Lookup(oldOne.assemblyResolverMethod, "Could not find assembly resolver method");
		InitMethod = Lookup(oldOne.InitMethod, "Could not find assembly resolver init method");
	}
	...
	bool CheckMethod(ISimpleDeobfuscator simpleDeobfuscator, MethodDef methodToCheck) {
		...
		string[] resolverLocals = new[] {
			"System.Byte[]", "System.Reflection.Assembly", "System.String", "System.IO.BinaryReader", "System.IO.Stream"
		};
		string[] resolverLocals2 = new[] { "System.Reflection.Assembly", "System.IO.BinaryReader", "System.IO.Stream" };

		string[] resolverLocals3 = new[] {
	...
	public List<ResourceInfo> GetEmbeddedAssemblies(ISimpleDeobfuscator simpleDeobfuscator, IDeobfuscator deob) {
		...
		foreach (string resourcePrefix in DotNetUtils.GetCodeStrings(assemblyResolverMethod))
