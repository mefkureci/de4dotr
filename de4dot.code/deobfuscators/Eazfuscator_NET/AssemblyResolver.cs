...
class AssemblyResolver {
	...
	readonly CodeCompilerMethodCallRestorer codeCompilerMethodCallRestorer;
	...
	public TypeDef OtherType { get; private set; }
	...
	TypeDef GetDecrypterType(MethodDef method) {
		...
		foreach (var instr in method.Body.Instructions) {
			if (instr.OpCode.Code != Code.Call)
				continue;
			var calledMethod = instr.Operand as MethodDef;
			if (calledMethod == null || !calledMethod.IsStatic || calledMethod.DeclaringType == Type)
				continue;
	...
	bool CreateDecryptKey() {
		...
		foreach (string s in DotNetUtils.GetCodeStrings(decryptMethod)) {
	...
	bool CreateAssemblyInfos() {
		...
		foreach (string s in DotNetUtils.GetCodeStrings(handlerMethod)) {
	...
	List<AssemblyInfo> TryCreateAssemblyInfos(string s, int numElements) {
		...
		for (int i = 0; i < ary.Length; i += numElements) {
			...
			if (index >= 0) {
				string flags = info.ResourceName.Substring(0, index);
	...
	byte[] Decompress(byte[] compressedData) =>
		...
		DeobUtils.Inflate(compressedData, 8, compressedData.Length - 8, true);

	public AssemblyInfo Get(string asmFullName) {
		string simpleName = Utils.GetAssemblySimpleName(asmFullName);
	...
	void FindCodeDomMethods() {
		...
		foreach (var nestedType in Type.NestedTypes) {
			...
			var CompileAssemblyFromDom1 = GetTheOnlyMethod(nestedType, "System.CodeDom.Compiler.CodeDomProvider",
				"CompileAssemblyFromDom", "System.CodeDom.Compiler.CompilerResults",
				"System.CodeDom.Compiler.CompilerParameters,System.CodeDom.CodeCompileUnit[]");
			var CompileAssemblyFromFile1 = GetTheOnlyMethod(nestedType, "System.CodeDom.Compiler.CodeDomProvider",
				"CompileAssemblyFromFile", "System.CodeDom.Compiler.CompilerResults",
				"System.CodeDom.Compiler.CompilerParameters,System.String[]");
			var CompileAssemblyFromSource1 = GetTheOnlyMethod(nestedType, "System.CodeDom.Compiler.CodeDomProvider",
				"CompileAssemblyFromSource", "System.CodeDom.Compiler.CompilerResults",
				"System.CodeDom.Compiler.CompilerParameters,System.String[]");
			var CompileAssemblyFromDom2 = GetTheOnlyMethod(nestedType, "System.CodeDom.Compiler.ICodeCompiler",
				"CompileAssemblyFromDom", "System.CodeDom.Compiler.CompilerResults",
				"System.CodeDom.Compiler.CompilerParameters,System.CodeDom.CodeCompileUnit");
			var CompileAssemblyFromDomBatch2 = GetTheOnlyMethod(nestedType, "System.CodeDom.Compiler.ICodeCompiler",
				"CompileAssemblyFromDomBatch", "System.CodeDom.Compiler.CompilerResults",
				"System.CodeDom.Compiler.CompilerParameters,System.CodeDom.CodeCompileUnit[]");
			var CompileAssemblyFromFile2 = GetTheOnlyMethod(nestedType, "System.CodeDom.Compiler.ICodeCompiler",
				"CompileAssemblyFromFile", "System.CodeDom.Compiler.CompilerResults",
				"System.CodeDom.Compiler.CompilerParameters,System.String");
			var CompileAssemblyFromFileBatch2 = GetTheOnlyMethod(nestedType, "System.CodeDom.Compiler.ICodeCompiler",
				"CompileAssemblyFromFileBatch", "System.CodeDom.Compiler.CompilerResults",
				"System.CodeDom.Compiler.CompilerParameters,System.String[]");
			var CompileAssemblyFromSource2 = GetTheOnlyMethod(nestedType, "System.CodeDom.Compiler.ICodeCompiler",
				"CompileAssemblyFromSource", "System.CodeDom.Compiler.CompilerResults",
				"System.CodeDom.Compiler.CompilerParameters,System.String");
			var CompileAssemblyFromSourceBatch2 = GetTheOnlyMethod(nestedType, "System.CodeDom.Compiler.ICodeCompiler",
				"CompileAssemblyFromSourceBatch", "System.CodeDom.Compiler.CompilerResults",
				"System.CodeDom.Compiler.CompilerParameters,System.String[]");
			...
			codeCompilerMethodCallRestorer
				.Add_ICodeCompiler_CompileAssemblyFromFileBatch(CompileAssemblyFromFileBatch2);
			codeCompilerMethodCallRestorer.Add_ICodeCompiler_CompileAssemblyFromSource(CompileAssemblyFromSource2);
			codeCompilerMethodCallRestorer.Add_ICodeCompiler_CompileAssemblyFromSourceBatch(
				CompileAssemblyFromSourceBatch2);
			break;
		}
	}

	static MethodDef GetTheOnlyMethod(TypeDef type, string typeName, string methodName, string returnType,
		string parameters) {
		...
		foreach (var method in type.Methods) {
			...
			if (!DotNetUtils.CallsMethod(method,
				    returnType + " " + typeName + "::" + methodName + "(" + parameters + ")"))
				continue;
