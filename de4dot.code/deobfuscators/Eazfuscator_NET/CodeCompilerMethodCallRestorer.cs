...
class CodeCompilerMethodCallRestorer : MethodCallRestorerBase {
	...
	ITypeDefOrRef CodeDomProvider =>
		builder.Type("System.CodeDom.Compiler", "CodeDomProvider", "System").ToTypeDefOrRef();
	...
	public void Add_CodeDomProvider_CompileAssemblyFromDom(MethodDef oldMethod) {
		if (oldMethod == null)
			return;
		Add(oldMethod,
			builder.InstanceMethod("CompileAssemblyFromDom", CodeDomProvider, CompilerResults, CompilerParameters,
				CodeCompileUnitArray));
	}
	...
	public void Add_CodeDomProvider_CompileAssemblyFromFile(MethodDef oldMethod) {
		if (oldMethod == null)
			return;
		Add(oldMethod,
			builder.InstanceMethod("CompileAssemblyFromFile", CodeDomProvider, CompilerResults, CompilerParameters,
				StringArray));
	}
	...
	public void Add_CodeDomProvider_CompileAssemblyFromSource(MethodDef oldMethod) {
		if (oldMethod == null)
			return;
		Add(oldMethod,
			builder.InstanceMethod("CompileAssemblyFromSource", CodeDomProvider, CompilerResults, CompilerParameters,
				StringArray));
	}
	...
	public void Add_ICodeCompiler_CompileAssemblyFromDom(MethodDef oldMethod) {
		if (oldMethod == null)
			return;
		Add(oldMethod,
			builder.InstanceMethod("CompileAssemblyFromDom", ICodeCompiler, CompilerResults, CompilerParameters,
				CodeCompileUnit));
	}
	...
	public void Add_ICodeCompiler_CompileAssemblyFromDomBatch(MethodDef oldMethod) {
		if (oldMethod == null)
			return;
		Add(oldMethod,
			builder.InstanceMethod("CompileAssemblyFromDomBatch", ICodeCompiler, CompilerResults, CompilerParameters,
				CodeCompileUnitArray));
	}
	...
	public void Add_ICodeCompiler_CompileAssemblyFromFile(MethodDef oldMethod) {
		if (oldMethod == null)
			return;
		Add(oldMethod,
			builder.InstanceMethod("CompileAssemblyFromFile", ICodeCompiler, CompilerResults, CompilerParameters,
				builder.String));
	}
	...
	public void Add_ICodeCompiler_CompileAssemblyFromFileBatch(MethodDef oldMethod) {
		if (oldMethod == null)
			return;
		Add(oldMethod,
			builder.InstanceMethod("CompileAssemblyFromFileBatch", ICodeCompiler, CompilerResults, CompilerParameters,
				StringArray));
	}
	...
	public void Add_ICodeCompiler_CompileAssemblyFromSource(MethodDef oldMethod) {
		if (oldMethod == null)
			return;
		Add(oldMethod,
			builder.InstanceMethod("CompileAssemblyFromSource", ICodeCompiler, CompilerResults, CompilerParameters,
				builder.String));
	}
	...
	public void Add_ICodeCompiler_CompileAssemblyFromSourceBatch(MethodDef oldMethod) {
		if (oldMethod == null)
			return;
		Add(oldMethod,
			builder.InstanceMethod("CompileAssemblyFromSourceBatch", ICodeCompiler, CompilerResults, CompilerParameters,
				StringArray));
	}
}
