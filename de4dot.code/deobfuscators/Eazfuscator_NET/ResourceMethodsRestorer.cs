...
class ResourceMethodsRestorer : MethodCallRestorerBase {
	...
	public void Find(ISimpleDeobfuscator simpleDeobfuscator, IDeobfuscator deob) {
		foreach (var type in module.Types) {
			...
			var getStream2 = GetTheOnlyMethod(type, "System.IO.Stream",
	...
	EmbeddedResource FindGetManifestResourceStreamTypeResource(TypeDef type, ISimpleDeobfuscator simpleDeobfuscator,
		IDeobfuscator deob) {
