...
class Deobfuscator : DeobfuscatorBase {
	...
	void DetectVersion() {
		string version = new VersionDetector(module, stringDecrypter).Detect();
		if (version == null)
			return;
	...
	void StringDecrypterBugWorkaround() {
		...
		var newType =
			module.UpdateRowId(new TypeDefUser(Guid.NewGuid().ToString("B"), module.CorLibTypes.Object.TypeDefOrRef));
		module.Types.Add(newType);
		var newMethod = module.UpdateRowId(new MethodDefUser("x", MethodSig.CreateStatic(module.CorLibTypes.Void), 0,
