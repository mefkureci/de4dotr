...
class StringDecrypter {
	...
	readonly FieldDefAndDeclaringTypeDict<StringInfo> stringInfos = new();
	...
	abstract class DecrypterBaseV11 : IDecrypter {
		protected readonly int fileDispl;
		protected uint[] key;
		protected BinaryReader reader;

		protected DecrypterBaseV11(RummageVersion version, MethodDef decrypterMethod, int fileDispl) {
			this.Version = version;
			this.Method = decrypterMethod;
			this.fileDispl = fileDispl;
		}

		public RummageVersion Version { get; }

		public MethodDef Method { get; }

		public void Initialize() {
			reader = new BinaryReader(new FileStream(Method.DeclaringType.Module.Location, FileMode.Open,
		...
		protected string DecryptInternal(int stringId) {
			...
			uint[] decrypted = new uint[(utf8Length + 11) / 8 * 2 - 1];
			decrypted[0] = v1;
	...
	class DecrypterV11 : DecrypterBaseV11 {
		static readonly string[] requiredFields = new[] { "System.UInt32[]" };

		static readonly string[] requiredLocals = new[] { "System.Byte[]", "System.Int32", "System.IO.FileStream" };
	...
	class DecrypterV21 : DecrypterBaseV11 {
		static readonly string[] requiredFields = new[] { "System.UInt32[]", "System.Int64" };

		static readonly string[] requiredLocals = new[] { "System.Byte[]", "System.Int32", "System.IO.FileStream" };

		static readonly byte[] magic = new byte[32] {
			0xC9, 0x76, 0xC3, 0x0D, 0xE2, 0x83, 0x72, 0xE4, 0xD5, 0xC7, 0x35, 0xF8, 0x86, 0xD0, 0x60, 0x69, 0xEE, 0xE1,
			0x4C, 0x5E, 0x07, 0xA1, 0xC1, 0xFE, 0x61, 0xE3, 0xAA, 0xBC, 0xE4, 0xB1, 0xF0, 0x92
		};
